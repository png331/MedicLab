...
ActiveRecord::Schema[7.0].define(version: 2022_04_20_075636) do
  ...
  create_table "examinations", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.decimal "weightKg", precision: 10, null: false
    t.decimal "heightCm", precision: 10, null: false
  ...
  create_table "perscription_drugs", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
